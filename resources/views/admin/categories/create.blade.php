    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="text-center py-6 px-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Tambah Kategori</h2>
                <p class="text-sm text-gray-600">Silakan lengkapi form untuk menambahkan kategori berita.</p>
            </div>

            <form action="{{ route('admin.categories.store') }}" method="POST" class="px-6 pb-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="id_kategori" placeholder="Contoh: KAT001" value="{{ old('id_kategori') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_kategori" placeholder="Contoh: Festival, Olahraga, Budaya" value="{{ old('nama_kategori') }}" required
