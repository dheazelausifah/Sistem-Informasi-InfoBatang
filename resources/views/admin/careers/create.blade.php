...
<div class="max-w-4xl mx-auto">
    <!-- Page Title -->
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Lowongan Pekerjaan</h2>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="judul" placeholder="Contoh: Content Creator" value="{{ old('judul') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi" placeholder="On-site | Kabupaten Batang" value="{{ old('lokasi') }}" required
                        ...
                        <div>
                            ...
                            <select name="level" required
                                ...
                                <option value="Freshgraduate" {{ old('level') == 'Freshgraduate' ? 'selected' : '' }}>Freshgraduate</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="gaji" placeholder="Negotiable / 3-4 jt" value="{{ old('gaji') }}"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="ADM001" disabled class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-500">
                            <input type="hidden" name="id_admin" value="ADM001">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="4" placeholder="Gambaran umum pekerjaan..." required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="tanggung_jawab" rows="4" placeholder="Apa yang dikerjakan..." required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none @error('tanggung_jawab') border-red-500 @enderror">{{ old('tanggung_jawab') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="kualifikasi" rows="4" placeholder="Syarat pelamar..." required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none @error('kualifikasi') border-red-500 @enderror">{{ old('kualifikasi') }}</textarea>
                            @error('kualifikasi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
